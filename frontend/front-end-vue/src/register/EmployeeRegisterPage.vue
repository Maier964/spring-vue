<template>
    <div>
        <h2>Employee Register Panel</h2>
        <form @submit.prevent="handleSubmit">
            <div class="form-group">
                <label for="username">Username email (will end with employee.food after registration)</label>
            ...
            <div>
                ...
                <input type="date" v-validate="{ required: false }" name="date" class="form-control" />
            </div>
            <br>
            <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        handleSubmit(e) {
            this.submitted = true;
            // Check if email contains @employee.food
            this.user.email = this.user.email + "@employee.food";
